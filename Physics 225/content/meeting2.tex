...
\subsection{Einstein's Equivalence Principle}
	...
	\subsubsection{Universality of Free Fall}
		...
		You release the same ball, and it falls downward with approximately
		...
		But but the observer actually are in Earth's gravitational field. In actual inertial motion, the same observations will take place.
